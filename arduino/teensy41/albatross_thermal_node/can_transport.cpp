...
void ThermalCanTransport::publishConfiguration(){const uint32_t c=ThermalProtocol::CONFIG_CRC32; uint8_t data[8]={uint8_t(c>>24),uint8_t(c>>16),uint8_t(c>>8),uint8_t(c),2,0,0,32}; send(ThermalProtocol::CONFIG_ID,data,8);}
