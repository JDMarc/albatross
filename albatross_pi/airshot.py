...
REASONS = ("NONE","OFF","UNCALIBRATED","CAN STALE","PRESSURE SENSOR","LOW PRESSURE","REGULATOR","ENGINE COLD","RPM RANGE","TORQUE LOW","DBW","TRACTION","WHEELIE","THERMAL","WMI","ECU PROTECTION","DRIVER","ALREADY BOOSTED","RECOVERY","MAX DURATION","RELEASED","SPOOL COMPLETE","OVERBOOST","BUDGET","WASTEGATE","SHADOW","SERVICE","FUEL","PRIMING","PRIME FAULT")
...
class AirShotV2:
    ...
    def alerts(self):
        ...
        if self.reason in ("PRESSURE SENSOR","REGULATOR","OVERBOOST","THERMAL","DBW","CAN STALE","LOW PRESSURE","WMI","WASTEGATE","UNCALIBRATED","PRIME FAULT") and self.mode!="OFF":
