...
FAULTS=("ENGINEERING CALIBRATION","FRONT WSS LOST","REAR WSS LOST","IMU LOST","IMU IMPLAUSIBLE","APS DISAGREEMENT","TPS DISAGREEMENT","DBW COMM LOSS","DBW POSITION ERROR","DBW DRIVER","MS3 CAN LOSS","APS RATE","IMU DRIFT","POWERTRAIN STOP LATCHED")
