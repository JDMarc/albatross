...
- Air Shot firing is a momentary Pi request over CAN; Arduino owns the actual latch, mode/rpm/tps/gear/tank/boost safety gates, 10 second max latch timeout, intake-pressure-vs-tank-pressure shutoff, and shutoff when requested boost is reached.
